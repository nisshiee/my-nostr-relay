...
1. When idsフィルターが指定された場合、the query builder shall イベントIDの完全一致または前方一致検索を生成する
2. When authorsフィルターが指定された場合、the query builder shall pubkeyの完全一致または前方一致検索を生成する

...
- [ ] 1.2 (P) リレー制限情報モデルを実装する
  - 制限情報を表現する構造体を作成
  - max_subid_length（64固定）を含める
  - 未実装の制限値は含めない設計とする
  - _Requirements: 4.1, 4.2, 4.3_

- [ ] 1.3 (P) コミュニティ・ロケール情報をモデルに追加する
...
- [ ] 2. インフラ層設定コンポーネントの実装
- [ ] 2.1 (P) 環境変数からリレー設定を読み込むコンポーネントを実装する
